 ...
 * Tests various attack vectors against the form validation system
 */
...
class SecurityTester {
  ...
  printResults() {
    ...
    const criticalFailures = this.results.details.filter(test => 
      !test.passed && (test.testName.includes('XSS') || test.testName.includes('SQL') || test.testName.includes('Command'))
    );
