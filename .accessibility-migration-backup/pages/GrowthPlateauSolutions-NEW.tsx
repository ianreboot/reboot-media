  ...
  const pageConfig: PageTemplateProps = {
    ...
    content: [
        ...
        content: (
          <div>
            ...
            <div className="bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 rounded-2xl p-8 border border-red-200/50 dark:border-red-800/50">
              ...
              <p className="text-lg text-standard-accessible dark:text-gradient-safe mb-6 max-w-3xl mx-auto">
      ...
      },
      {
        ...
        content: (
          <div>
            <p className="text-xl text-standard dark:text-gradient-safe mb-16 text-center max-w-4xl mx-auto">
              ...
              {plateauTypes.map((plateau) => (
                <div key={plateau.id} className="group">
                  ...
                  >
                    ...
                    <p className="text-standard-accessible dark:text-gradient-safe text-base leading-relaxed mb-6">
                      {plateau.description}
                    </p>
        ...
        content: (
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-8 hover:shadow-2xl focus-visible:shadow-2xl transition-shadow">
              ...
              <p className="text-lg text-standard dark:text-gradient-safe mb-6">
