    ...
    <div className="terms-page min-h-screen relative overflow-hidden dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900">
      ...
      <div className="pt-16 pb-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 p-6 sm:p-8">
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="mb-4 text-standard dark:text-gradient-safe">You agree to use our services and website only for lawful business purposes. You shall not:</p>
                <ul className="list-disc list-inside space-y-2 text-standard dark:text-gradient-safe">
              ...
              <section>
                ...
                <p className="mb-4 text-standard dark:text-gradient-safe">While we bring extensive C-level experience and proven methodologies, you acknowledge that:</p>
                <ul className="list-disc list-inside space-y-2 text-standard dark:text-gradient-safe">
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 mb-4 text-standard dark:text-gradient-safe">
