...
const Terms = () => {
  ...
  return (
    <div className="terms-page min-h-screen relative overflow-hidden">
          ...
          <div className="glass-card-light rounded-2xl shadow-xl border border-white/20 p-6 sm:p-8">
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="mb-4 text-white/90">You agree to use our services and website only for lawful business purposes. You shall not:</p>
                <ul className="list-disc list-inside space-y-2 text-white/90">
              ...
              <section>
                ...
                <p className="mb-4 text-white/90">While we bring extensive C-level experience and proven methodologies, you acknowledge that:</p>
                <ul className="list-disc list-inside space-y-2 text-white/90">
              ...
              <section>
                ...
                <h3 className="heading-lg text-white mb-3">Prevailing Party Attorney's Fees</h3>
                <p className="mb-4 text-white/90">
                ...
                <h3 className="heading-lg text-white mb-3">Frivolous Claim Penalties</h3>
                ...
                <h3 className="heading-lg text-white mb-3">Anti-SLAPP Protection</h3>
                <p className="mb-4 text-white/90">
              ...
              <section>
                ...
                <h3 className="heading-lg text-white mb-3">New Law Grace Period</h3>
                <p className="mb-4 text-white/90">
                ...
                <h3 className="heading-lg text-white mb-3">Industry Standard Defense</h3>
                <p className="mb-4 text-white/90">
                ...
                <h3 className="heading-lg text-white mb-3">Accessibility Compliance</h3>
                <p className="mb-4 text-white/90">
                ...
                <h3 className="heading-lg text-white mb-3">Data Protection Safe Harbors</h3>
                <ul className="list-disc list-inside space-y-2 text-white/90">
