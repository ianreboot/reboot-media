        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 p-6 sm:p-8">
            ...
            <div className="space-y-8">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">3. Acceptable Use</h2>
                <p className="mb-4 text-standard dark:text-gray-300">You agree to use our services and website only for lawful business purposes. You shall not:</p>
                <ul className="list-disc list-inside space-y-2 text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">4. Service Limitations and Expectations</h2>
                <p className="mb-4 text-standard dark:text-gray-300">While we bring extensive C-level experience and proven methodologies, you acknowledge that:</p>
                <ul className="list-disc list-inside space-y-2 text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">5. Intellectual Property and Confidentiality</h2>
                <p className="mb-4 text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">6. Payment Terms and Cancellation</h2>
                <p className="mb-4 text-standard dark:text-gray-300">
              ...
              <section>
                ...
                <p className="text-standard dark:text-gray-300">
                  ...
                  <Link to="/privacy" className="transparent-link" onClick={() => window.scrollTo(0, 0)}>comprehensive Privacy Policy</Link>. 
                  By engaging our services, you consent to the collection and use of information as described in the Privacy Policy.
                </p>
              </section>

              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">8. Service Termination</h2>
                <p className="mb-4 text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">9. Disclaimer of Warranties</h2>
                <p className="text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">10. Limitation of Liability</h2>
                <p className="mb-4 text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">11. Governing Law and Disputes</h2>
                <p className="mb-4 text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">12. Defense Against Regulatory Complaints</h2>
                <p className="mb-4 text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">13. Anti-Frivolous Litigation Provisions</h2>
                <p className="mb-4 text-standard dark:text-gray-300">
                ...
                <ul className="list-disc list-inside space-y-2 mb-4 text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">14. Specific Legal Compliance and Safe Harbors</h2>
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">15. Changes to Terms</h2>
                <p className="text-standard dark:text-gray-300">
              ...
              <section>
                ...
                <div className="bg-gray-50 dark:bg-slate-800 p-4 rounded-lg">
                  ...
                  <p className="text-standard dark:text-gray-300">Contact Form: <Link to="/contact" className="text-orange-500 hover:text-orange-600 underline" onClick={() => window.scrollTo(0, 0)}>Submit inquiry</Link></p>
                </div>
              </section>
