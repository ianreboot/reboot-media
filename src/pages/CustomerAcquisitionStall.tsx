          ...
          <section className="pt-20 md:pt-24 pb-16 bg-gradient-to-br from-orange-900 via-orange-950 to-black relative overflow-hidden">
            ...
            <div className="relative max-w-5xl mx-auto px-6 lg:px-8">
              ...
              <div className="text-center">
                ...
                <p className="text-black-important text-xl replace-text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
          ...
          className="max-w-5xl mx-auto px-6 lg:px-8 py-16">
            ...
            <section className="mb-16">
              <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-2xl shadow-xl border border-orange-200/50 dark:border-orange-800/50 p-8">
                ...
                <p className="text-black-important text-lg text-standard dark:replace-text-gray-300 mb-6 leading-relaxed text-center">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-6">
                  <div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                    ...
                    <p className="text-sm text-optional dark:replace-text-gray-400">Experience CAC inflation</p>
                  </div>
                  <div className="text-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-red-600 mb-1">156%</div>
                    <p className="text-sm text-optional dark:replace-text-gray-400">Average CAC increase</p>
                  </div>
                ...
                <p className="text-black-important text-standard dark:replace-text-gray-300 font-semibold text-center">
            ...
            <section className="mb-16">
              <div className="text-center bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl p-8 border border-orange-200/50 dark:border-orange-800/50">
                ...
                <p className="text-black-important text-lg text-black-standard dark:replace-text-gray-300 mb-6 max-w-3xl mx-auto">
