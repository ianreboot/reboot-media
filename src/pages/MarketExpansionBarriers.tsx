        ...
        <div className="relative z-10">
          ...
          className="max-w-5xl mx-auto px-6 lg:px-8 py-16">
            ...
            <section className="mb-16">
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-yellow-200/50 dark:border-yellow-800/50 p-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-6">
                  <div className="text-center p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                    ...
                    <p className="text-sm text-optional dark:luminescence-layer-3">Feel market constrained</p>
                  </div>
                  <div className="text-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-red-600 mb-1">3.4x</div>
                    <p className="text-sm text-optional dark:luminescence-layer-3">Larger addressable market</p>
                  </div>
                  <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-green-600 mb-1">22%</div>
                    <p className="text-sm text-optional dark:luminescence-layer-3">Succeed with repositioning</p>
                  </div>
                </div>
