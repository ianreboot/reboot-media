        ...
        >
          ...
          <section id="awareness-stages" className="mb-8">
            ...
            <div className="space-y-12">
              ...
              {/* Stage 1: Unaware */}
              <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:shadow-lg focus-visible:shadow-lg transition-shadow glass-card-light">
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:shadow-lg focus-visible:shadow-lg transition-shadow glass-card-light">
                ...
                <div className="mt-6 p-4 glass-card rounded-lg border border-white/30 dark:border-slate-600/30">
          ...
          <section className="mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              {/* Loss Aversion */}
              <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 glass-card-light">
                ...
                <div className="glass-card rounded-lg p-4 border border-white/30 dark:border-slate-600/30">
            ...
            {/* Strategic CTA */}
            <div className="text-center glass-card-light rounded-2xl shadow-xl border border-white/30 dark:border-slate-700/30 p-8">
          ...
          <section className="mb-8">
            ...
            <div className="glass-card-light rounded-2xl shadow-xl border border-white/30 dark:border-slate-700/30 p-8">
