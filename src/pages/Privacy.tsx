        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 p-6 sm:p-8">
            ...
            <div className="space-y-8">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">1. Introduction</h2>
                ...
                <p className="text-sm text-optional dark:text-gray-400">
                  Our Company Address: 17595 Harvard Ave C-738, Irvine, CA 92614, USA.
                </p>
              </section>

              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">2. Information We Collect</h2>
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">3. How We Use Your Information</h2>
                <ul className="list-disc list-inside space-y-2 text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">4. Data Sharing and Disclosure</h2>
                <p className="mb-4 text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">5. Your Data Rights and Choices</h2>
                <ul className="list-disc list-inside space-y-2 text-standard dark:text-gray-300">
                ...
                <p className="mt-4 text-standard dark:text-gray-300">
                  ...
                  <Link to="/contact" className="transparent-link" onClick={() => window.scrollTo(0, 0)}>contact form</Link>.
                </p>
              </section>

              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">6. Regional Privacy Rights and Compliance</h2>
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">7. Enhanced Data Security and Retention</h2>
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">8. International Data Transfers</h2>
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">9. Children's Privacy</h2>
                <p className="text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">10. Cookies and Tracking Technologies</h2>
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">11. Third-Party Services and Data Sharing</h2>
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">12. Changes to This Privacy Policy</h2>
                <p className="text-standard dark:text-gray-300">
              ...
              <section>
                <h2 className="heading-xl text-critical dark:text-white mb-4">13. Contact Us</h2>
                <p className="mb-4 text-standard dark:text-gray-300">
