              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-blue-200/50 dark:border-blue-800/50 p-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-6">
                  <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    ...
                    <p className="text-sm text-optional dark:luminescence-layer-3">Struggle with team scaling</p>
                  </div>
                  <div className="text-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-red-600 mb-1">43%</div>
                    <p className="text-sm text-optional dark:luminescence-layer-3">New hire failure rate</p>
                  </div>
                  <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-green-600 mb-1">11%</div>
                    <p className="text-sm text-optional dark:luminescence-layer-3">Break founder dependency</p>
                  </div>
                </div>
