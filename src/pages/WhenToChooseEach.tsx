  ...
  return (
    <>
      <SEOHead 
        ...
        canonicalUrl="https://www.rebootmedia.net/fractional-cmo-guide/when-to-choose-each"
      />
          ...
          <main className="max-w-5xl mx-auto px-6 lg:px-8 py-16">
              ...
              <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-2xl shadow-xl border border-indigo-200/50 dark:border-indigo-800/50 p-8">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 mt-1">DIY → Consultant for validation</p>
                  </div>
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <strong className="text-blue-800 dark:text-blue-300">$500K-1M Revenue:</strong>
                    <p className="text-gray-700 dark:text-gray-300 mt-1">Fractional CMO + Tactical agency</p>
                  </div>
                  <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <strong className="text-green-800 dark:text-green-300">$1M-3M Scaling:</strong>
                    <p className="text-gray-700 dark:text-gray-300 mt-1">Fractional CMO leading strategy</p>
                  </div>
                  <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                    <strong className="text-purple-800 dark:text-purple-300">$3M-5M Growth:</strong>
                    <p className="text-gray-700 dark:text-gray-300 mt-1">Fractional + In-house team</p>
                  </div>
                  <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    <strong className="text-red-800 dark:text-red-300">Crisis/Turnaround:</strong>
                    <p className="text-gray-700 dark:text-gray-300 mt-1">Fractional CMO immediately</p>
                  </div>
                  <div className="p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                    <strong className="text-indigo-800 dark:text-indigo-300">$5M+ Established:</strong>
                    <p className="text-gray-700 dark:text-gray-300 mt-1">Full-time CMO + complete team</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 p-6 hover:shadow-xl transition-shadow">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">
                    <Link to="/growth-plateau-solutions" className="hover:text-indigo-600 transition-colors" onClick={() => window.scrollTo(0, 0)}>
