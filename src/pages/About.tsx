      ...
      <div className="pt-20 sm:pt-16 pb-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 p-6 sm:p-8 mb-8">
            <h2 className="heading-xl text-critical dark:text-white mb-6">Our Story</h2>
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div className="space-y-4 text-standard dark:text-gray-300">
          ...
          {/* Leadership */}
          <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 p-6 sm:p-8 mb-8">
            <h2 className="heading-xl text-critical dark:text-white mb-8 text-center">Leadership</h2>
            <div className="max-w-4xl mx-auto">
              <div className="flex flex-col lg:flex-row items-center gap-8">
                ...
                <div className="lg:w-2/3 space-y-4">
                  ...
                  <p className="text-standard dark:text-gray-300 leading-relaxed">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 p-6 text-center">
              ...
              <p className="text-optional dark:text-gray-400">Revenue Managed</p>
            </div>
            <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 p-6 text-center">
              ...
              <p className="text-optional dark:text-gray-400">US Companies</p>
            </div>
            <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 p-6 text-center">
              ...
              <p className="text-optional dark:text-gray-400">Average Revenue Growth</p>
            </div>
            <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 p-6 text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">USA • Bangkok • Singapore</p>
            </div>
          </div>
          ...
          <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 p-6 sm:p-8 mb-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-optional dark:text-gray-400 text-sm">Every strategy must drive measurable business growth</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-optional dark:text-gray-400 text-sm">Fortune 500 standards applied to every engagement</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-optional dark:text-gray-400 text-sm">Clear communication and honest feedback always</p>
              </div>
            </div>
          </div>
