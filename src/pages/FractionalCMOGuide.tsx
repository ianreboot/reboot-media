      ...
      <div className="fractional-cmo-page min-h-screen relative overflow-hidden dark:bg-gray-900">
        ...
        <main 
          ...
          <section className="mb-16">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-blue-200/50 dark:border-blue-800/50 p-8">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden hover:shadow-2xl focus-visible:shadow-2xl transition-all duration-300 transform hover:scale-105 focus-visible:scale-105">
              ...
              <div className="group bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden hover:shadow-2xl focus-visible:shadow-2xl transition-all duration-300 transform hover:scale-105 focus-visible:scale-105 md:col-span-2">
