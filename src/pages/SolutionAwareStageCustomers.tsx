  ...
  return (
    <>
      <SEOHead 
        ...
        canonicalUrl="https://www.rebootmedia.net/marketing-psychology/solution-aware-stage-customers"
      />
            ...
            <section className="mb-12">
              ...
              <div className="space-y-8">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Customer thinks:</h3>
                    <p className="text-gray-700 dark:text-gray-300 italic">"Should we hire an agency, a consultant, or build in-house?"</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-red-600 dark:text-red-400 mb-2">What they're really asking:</h3>
                    <p className="text-gray-700 dark:text-gray-300">Who can actually deliver results without creating more work for us? They're weighing speed, control, expertise, and internal politics.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-green-600 dark:text-green-400 mb-2">How to position yourself:</h3>
                    <p className="text-gray-700 dark:text-gray-300">Show the hidden costs of each option. "Agencies give you execution but not strategy. In-house gives you control but takes 6 months to ramp. A fractional CMO gives you both strategy and execution starting week one."</p>
                  </div>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Customer thinks:</h3>
                    <p className="text-gray-700 dark:text-gray-300 italic">"Everyone says they're data-driven and results-focused"</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-red-600 dark:text-red-400 mb-2">What they're really asking:</h3>
                    <p className="text-gray-700 dark:text-gray-300">Show me proof that works for companies exactly like mine. Generic case studies mean nothing—they want to see themselves in your success stories.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-green-600 dark:text-green-400 mb-2">How to position yourself:</h3>
                    <p className="text-gray-700 dark:text-gray-300">Get specific about your sweet spot. "We specifically help B2B SaaS companies between $1M-$5M ARR double their qualified pipeline in 6 months. Here's how we did it for three companies just like yours."</p>
                  </div>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Customer thinks:</h3>
                    <p className="text-gray-700 dark:text-gray-300 italic">"How do we know this will work for us?"</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-red-600 dark:text-red-400 mb-2">What they're really asking:</h3>
                    <p className="text-gray-700 dark:text-gray-300">What happens if this fails? They're risk-assessing, thinking about their reputation, budget waste, and opportunity cost.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-green-600 dark:text-green-400 mb-2">How to position yourself:</h3>
                    <p className="text-gray-700 dark:text-gray-300">Remove the risk entirely. "Start with a paid pilot project. We'll fix one specific problem in 30 days. If it works, we continue. If not, you've got a solution and we part ways."</p>
                  </div>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Customer thinks:</h3>
                    <p className="text-gray-700 dark:text-gray-300 italic">"The expensive option must be better, right?"</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-red-600 dark:text-red-400 mb-2">What they're really asking:</h3>
                    <p className="text-gray-700 dark:text-gray-300">How do we justify the cost internally? They need ammunition to sell this decision to their boss, board, or team.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-green-600 dark:text-green-400 mb-2">How to position yourself:</h3>
                    <p className="text-gray-700 dark:text-gray-300">Show ROI in their language. "The $10K/month investment typically returns $50K in monthly recurring revenue within 6 months. But more importantly, you're buying back 20 hours of your week."</p>
                  </div>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Customer thinks:</h3>
                    <p className="text-gray-700 dark:text-gray-300 italic">"What if we pick the wrong partner?"</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-red-600 dark:text-red-400 mb-2">What they're really asking:</h3>
                    <p className="text-gray-700 dark:text-gray-300">How painful will it be to switch if this doesn't work out? They're thinking about contracts, knowledge transfer, and sunk costs.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-green-600 dark:text-green-400 mb-2">How to position yourself:</h3>
                    <p className="text-gray-700 dark:text-gray-300">Make leaving easy. "Everything we build is yours. All strategies documented. All campaigns transferable. If you ever want to bring it in-house, we'll train your team."</p>
                  </div>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Customer thinks:</h3>
                    <p className="text-gray-700 dark:text-gray-300 italic">"They all have impressive portfolios"</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-red-600 dark:text-red-400 mb-2">What they're really asking:</h3>
                    <p className="text-gray-700 dark:text-gray-300">But can they replicate that success for us? Past performance doesn't guarantee future results, especially in different industries.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-green-600 dark:text-green-400 mb-2">How to position yourself:</h3>
                    <p className="text-gray-700 dark:text-gray-300">Show your process, not just results. "Here's the exact 90-day playbook we'll run for you. We've refined it across 50+ implementations. Let me show you what weeks 1-12 look like."</p>
                  </div>
