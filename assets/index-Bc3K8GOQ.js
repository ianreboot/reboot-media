        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("section", { id: "home", className: "min-h-screen flex items-center relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "w-full py-8", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10", children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto", children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "group relative bg-white/50 backdrop-blur-md border-l-4 border-orange-500 rounded-r-xl p-5 shadow-lg hover:shadow-xl focus-visible:shadow-xl transition-all duration-300 hover:scale-105 focus-visible:scale-105 cursor-pointer", style: { backdropFilter: "blur(12px)" }, children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "text-center", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "group relative bg-white/50 backdrop-blur-md border-l-4 border-blue-500 rounded-r-xl p-5 shadow-lg hover:shadow-xl focus-visible:shadow-xl transition-all duration-300 hover:scale-105 focus-visible:scale-105 cursor-pointer", style: { backdropFilter: "blur(12px)" }, children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "text-center", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "group relative bg-white/50 backdrop-blur-md border-l-4 border-green-500 rounded-r-xl p-5 shadow-lg hover:shadow-xl focus-visible:shadow-xl transition-all duration-300 hover:scale-105 focus-visible:scale-105 cursor-pointer", style: { backdropFilter: "blur(12px)" }, children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "text-center", children: [
...
//# sourceMappingURL=index-Bc3K8GOQ.js.map
