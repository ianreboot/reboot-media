              ...
              formData.specificIssue && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "bg-white/50 dark:bg-slate-700/50 backdrop-blur-fallback-sm rounded-xl p-4 border border-white/20 dark:border-slate-600/20", children: [
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-2 gap-2", children: [
                  ...
                  "button",
                  {
                    ...
                    className: `px-3 py-2 rounded-lg border-2 text-xs font-medium transition-all duration-300 ${formData.timeline === option.value ? "border-orange-500 bg-white/50 dark:bg-slate-700/50 backdrop-blur-fallback-sm text-orange-700 dark:text-orange-300" : "border-gray-200 hover:border-gray-300"}`,
