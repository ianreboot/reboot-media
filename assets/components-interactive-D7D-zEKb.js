...
import { u as useConversionOptimization, a as usePricingOptimization, b as useCTAOptimization, c as useLeadForm, d as useFormOptimization, e as useError } from "./app-state-DJgpQx31.js";
const services = [
  {
    title: "STARTER",
    size: "Small",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: `rounded-3xl border-2 ${service.popular ? "p-6" : "p-5"} text-center flex flex-col transition-all duration-500 ${service.popular ? "flex-1" : ""} ${service.color === "orange" ? `bg-gradient-to-br from-orange-500 to-orange-600 text-white border-orange-400 shadow-2xl ${hovered ? "scale-105" : "lg:scale-[1.02]"}` : service.color === "blue" ? `bg-gradient-to-br from-blue-600 to-blue-700 text-white border-blue-400 shadow-xl ${hovered ? "scale-105" : ""}` : `bg-white border-gray-200 shadow-lg ${hovered ? "scale-105 shadow-2xl" : ""}`}`, children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mb-4", children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: `text-sm ${service.color === "gray" ? "replace-text-gray-600" : "text-white/90"}`, children: service.subtitle }, void 0, false, {
              fileName: "/home/ian/projects/reboot/src/components/EnhancedPricingCards.tsx",
              lineNumber: 242,
              columnNumber: 11
            }, void 0)
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: `text-xs mb-4 ${service.color === "gray" ? "replace-text-gray-600" : "text-white/80"}`, children: service.duration }, void 0, false, {
            fileName: "/home/ian/projects/reboot/src/components/EnhancedPricingCards.tsx",
            lineNumber: 304,
            columnNumber: 9
          }, void 0),
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            "button",
            {
              ...
              className: `w-full py-3 rounded-xl font-bold transition-all duration-300 ${service.color === "orange" ? "bg-white text-orange-accessible hover:bg-orange-50" : service.color === "blue" ? "bg-white text-blue-700 hover:bg-blue-50" : leadTier === "Hot" ? "bg-red-600 text-white hover:bg-red-700 animate-pulse" : "bg-blue-900 text-white hover:bg-blue-800"}`,
              children: getCTAText()
            },
            void 0,
            false,
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "bg-white rounded-2xl p-6 max-w-lg mx-auto shadow-2xl", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                "button",
                {
                  ...
                  className: `w-full py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl ${formData.revenue ? "bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white" : "bg-gray-300 replace-text-gray-500 cursor-not-allowed"}`,
                  children: [
                    "Continue to ",
...
//# sourceMappingURL=components-interactive-D7D-zEKb.js.map
