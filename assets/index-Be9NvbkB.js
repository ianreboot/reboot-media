        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("section", { id: "about", className: "px-4 sm:px-6 lg:px-8", style: { paddingTop: "clamp(3rem, 8vw, 5rem)", paddingBottom: "clamp(3rem, 8vw, 5rem)" }, children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "max-w-6xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 mb-12", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border border-orange-200/30 dark:border-orange-400/30 rounded-2xl p-6 shadow-xl transition-all duration-500 hover:scale-105 hover:-rotate-1 cursor-pointer", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-gray-600 text-sm leading-relaxed", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-white/95", children: [
                "I've spent ",
...
//# sourceMappingURL=index-Be9NvbkB.js.map
